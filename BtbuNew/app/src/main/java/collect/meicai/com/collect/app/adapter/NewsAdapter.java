package collect.meicai.com.collect.app.adapter;
...
import collect.meicai.com.collect.app.utils.DateTools;
import collect.meicai.com.collect.app.utils.Options;
...
public class NewsAdapter extends BaseAdapter implements SectionIndexer, HeadListView.HeaderAdapter, OnScrollListener{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mHolder.comment_count.setText("发布时间:");
...
//			head_title.setText(news.getDate());
	...
	public void configureHeader(View header, int position, int alpha) {
		int realPosition = position;
		int section = getSectionForPosition(realPosition);
		((TextView) header.findViewById(R.id.section_text)).setVisibility(View.GONE);
