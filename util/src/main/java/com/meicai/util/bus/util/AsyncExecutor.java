...
import com.meicai.util.bus.EventBus;

/**
 * Executes an {@link com.meicai.util.bus.util.AsyncExecutor.RunnableEx} using a thread pool. Thrown exceptions are propagated by posting failure events of any
...
public class AsyncExecutor {
    ...
    /** Posts an failure event if the given {@link com.meicai.util.bus.util.AsyncExecutor.RunnableEx} throws an Exception. */
